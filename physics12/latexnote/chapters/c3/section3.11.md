...
- The Outer layers of get **drawn toward the core at very high speed**
...
#### If the original star was large (greater than 20 times the mass of sun)
- Force of gravity is so large that the neutrons get drawn into each other
...
- So weaker gravational field.

#### The location where very close to singularity
- Much stronger
This is the formula solve for the strength of gravational field 
$$
    g = \frac{
        GM
    }{
...
If we approach to the singularity , the distance approaches to 0
The $g$ approaches to $\infty$

Eventuraly nothing can escape 

The closet point which light can still have enough energy to escape is called **The event Horizon**
...
E_{m1} = E_{m2}\\
0 = E_{k} + E_g\\
0 = \frac{1}{2}mv^2 + (-\frac{GMm}{R_s})\\
0 = \frac{1}{2}c^2 - \frac{GM}{R_s}\\
R_s = \frac{2GM}{c^2}
$$
M is the mass of the blackhole
c is $3.0 * 10^8$
$R_s$ is the Schwarzschild Radius ($R_s$)
