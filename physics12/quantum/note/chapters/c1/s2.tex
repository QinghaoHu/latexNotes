...
$\Delta t_s$ is a Synchronized clock measurement of the time from $v$'s frame of reference. $\Delta t$ is the moving clock measurement from a stationary perspective. 
...
If we look at the factor of the $\gamma$, it only matters when the speed of the rocket is fast enoguh!