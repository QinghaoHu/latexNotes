...
\underline{relative} magnitude of the charge on each pitch ball. 
...
If the charged objects had a reasonably large size, then the electrical force on each object would cause the changes to \underline{\textit{move inside}} of each object. In a point charge, 
the charge is unable to move around. 
...
\begin{itemize}
    \item $k > G$
    \item $F_E$ can be both attraction and repulson.
\end{itemize}