...
\begin{definition}[Spring Force]
     Can be wrote as $F_{spring}$. It is the force exerted by the spring on a object. 
\end{definition}
...
\begin{definition}[Plastic Region]
     The object no longer obeys Hooke's Law. The object's shape is now permanetly changed. 
\end{definition}
