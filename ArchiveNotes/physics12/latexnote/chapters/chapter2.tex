...
\begin{redblock}
    \textbf{Explanation:} When the object is viewed from a \red{non-inertial F.O.R.}, we introduce fictitious forces to explain its motion and behavior.
\end{redblock}
...
\begin{paracol}{2}
    ...
    \begin{rightcolumn}
        ...
        \textbf{musculoskeletal system develops} to withstand it.
    \end{rightcolumn}
\end{paracol}
...
\begin{enumerate}
    ...
    \item As an object speeds up, its \textbf{mass increases}. If the mass increases, the net force would also need to increase to maintain the acceleration.
\end{enumerate}

\subsection*{Solution 2}
Get a very large hollow ring and make it spin\\

For an internal F.O.R., there will be both \textbf{normal force} and \textbf{gravitational force} acting on it\\
...
\subsection*{Note}
    ...
    \begin{itemize}
        ...
        \item The question states the object is \textbf{at the equator}
    \end{itemize}
