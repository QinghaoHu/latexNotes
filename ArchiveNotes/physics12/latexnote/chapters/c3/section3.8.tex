...
\end{remark}
    ...
    \textbf{First half of the collision}: The interaction forces cause the objects to deform. As the objects deform, 
...
elastic potential energy \textbf{back into $E_k$}\\
    ...
    \textbf{After the collision}: The system's mechanical energy is now entirely $E_k$; at this time, $E_s = 0$. All $E_s$ is transferred back to $E_k$. 
...
\textbf{During the second half of the collision}: \begin{itemize}
    ...
    \item The distance between the carts is increasing
...
\begin{remark}
    Elastic collisions \textbf{cannot occur} between visible objects in real life. At least some of the energy will be lost as thermal or sound. 
\end{remark}
...
After the collision, the objects involved in the collision will be \textbf{stuck/attached together}.\\

\textbf{Apple and arrow} is an example of this type of collision. \\
