...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\textwidth]{pictures/SHM.png}
\end{figure}
...
\begin{definition}
    [Simple Harmonic Motion] Go through repeated oscillations at the same amplitude. 
\end{definition}
...
\begin{align*}
    ...
    T &= \sqrt{\frac{4\pi^2 mR}{kx}} \quad (\text{At this point, } R = x)\\
