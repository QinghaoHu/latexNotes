...
\begin{itemize}
    ...
    \item Geothermalm \fillin{3cm} break down kerogen as it is buried deep in the Earth.
...
\begin{itemize}
    \item \fillin{3cm} Rocks
    \item \fillin{3cm} Rocks
    \item \fillin{3cm} rocks
    \item Structural Traps (anticlines, domes, salt domes, faults)
\end{itemize}
